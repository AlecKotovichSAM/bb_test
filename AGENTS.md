...
**ВАЖНО:** При любых изменениях в API, структуре данных или функциональности необходимо актуализировать README.md.

**Правила:**

1. **Обновлять README при изменении API** - при добавлении новых endpoints, изменении существующих или изменении формата данных нужно обновить соответствующие разделы README

2. **Обновлять описание сущностей** - при изменении структуры сущностей (добавление/удаление полей, изменение связей) нужно обновить раздел "Основные сущности"

3. **Обновлять примеры** - примеры запросов и ответов должны соответствовать реальному API

4. **Обновлять список миграций** - при добавлении новых миграций нужно обновить раздел "Миграции базы данных"

5. **Проверять актуальность** - перед завершением работы проверять, что README отражает текущее состояние проекта

**Что нужно проверять и обновлять:**

- Раздел "Основные сущности" - описание полей и связей
- Раздел "API Endpoints" - все endpoints с примерами запросов и ответов
- Раздел "Миграции базы данных" - список всех миграций
- Примеры использования в разделе "E2E Тесты и сценарии использования"

**Правило:** README должен всегда отражать актуальное состояние API и структуры данных. Устаревшая документация вводит в заблуждение и усложняет работу с проектом.
